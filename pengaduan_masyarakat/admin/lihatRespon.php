...
<body style="padding: 20px;">
    <div class="row">
        ...
        <h3 style="font-weight: bold; margin-bottom: 50px; color: #283593;">LAPORAN YANG SUDAH DITANGGAPI</h3>
        </div> 
    ...
    <table border="3" class="table table-striped table-hover striped highlight" style="width: 100%; margin-inline: auto;">
        ...
        <?php
            ...
            $pengaduan = mysqli_query($koneksi,"SELECT * FROM pengaduan INNER JOIN masyarakat ON pengaduan.nik=masyarakat.nik INNER JOIN tanggapan ON pengaduan.id_pengaduan=tanggapan.id_pengaduan INNER JOIN jenis_aduan ON pengaduan.id_aduan = jenis_aduan.id_aduan INNER JOIN petugas ON tanggapan.id_petugas=petugas.id_petugas WHERE tanggapan.id_pengaduan = '$id_pengaduan' ORDER BY tanggapan.id_pengaduan DESC");
