    ...
    <div class="row">
      <div class="col s12 m3">
          <ul id="slide-out" class="sidenav sidenav-fixed">
              <li>
                  <div class="user-view">
                      <div class="background">
                          <img src="../img/progile.png">
                      </div>
					  <div class="pengguna" style="display: flex; gap: 20px;">
					  <a href="#user"><img class="circle" src="../img/366364.jpg" style="object-fit: cover;"></a>
					  <div class="nama-pengguna" style="display: block;">
					  <a href="#name"><span class="name" style="color: white; font-size: 20px;"><?php echo ucwords($_SESSION['data']['nama_petugas']); ?></span></a><span style="color: white;">Admin Website</span>
					  </div>
					  </div>
                  </div>
              ...
              <li><a href="index.php?p=grafik"><i class="fa-solid fa-chart-line fa-lg" style="padding-left: 5px;"></i>Grafik</a></li>
              <li>
