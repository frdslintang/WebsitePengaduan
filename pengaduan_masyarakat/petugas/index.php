    ...
    <div class="row">
      <div class="col s12 m3">
          <ul id="slide-out" class="sidenav sidenav-fixed">
              <li>
                  <div class="user-view">
                      <div class="background" style="margin-bottom: -20px;">
                      ...
                      <a href="#name"><span class="name" style="color: white; font-size: 20px;"><?php echo ucwords($_SESSION['data']['nama_petugas']); ?></span></a><span style="color: white;"> Petugas Aduan</span>
                      </div>
                      </div>
                  </div>
              </li>
