              ...
              <li>
                  <div class="user-view">
                      ...
                      <a href="#user"><img class="circle" src="../img/366364.jpg" style="object-fit: cover;"></a>
					            <span class="name" style="color: white; font-size: 20px;"><?php echo ucwords($_SESSION['username']); ?></span>
                  </div>
                  <br>
              </li>
              <li><a href="index.php?p=dashboard"><i class="material-icons">dashboard</i>Dashboard</a></li>
              <li><a href="index.php?p=profile"><i class="fa-solid fa-user fa-lg" style="padding-left: 5px;"></i>Profile</a></li>
              <li>
